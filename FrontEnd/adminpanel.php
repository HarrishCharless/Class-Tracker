...
<?php
    ...
    if(!isset($_POST['search'])){
        ...
        echo "<script>alert('filtering')</script>";
    }
?>
...
<main>
    <div class="container-fluid ">
        <h3 class="my-3 text-primary text-center">Welcome Admin!</h3>
        ...
        <div class="container border border-secondary rounded my-3">
            ...
            <form method="POST" action="adminpanel.php">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control m-1" placeholder="Enter Classno">
                    </div>
